<template>
  <div class="vegetables" v-loading="this.isLoading">
    <div class="wraper row" v-if="filterVegetables().length !== 0">
      <div
    ...
    <el-pagination
      ...
      v-if="filterVegetables().length !== 0"
    >
    </el-pagination>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    filterVegetables() {
      ...
      const vegetables = products.filter((food) => food.type === "vegetables");
      return vegetables;
    },
    sortProducts() {
